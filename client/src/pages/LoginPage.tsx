    ...
    <div className="min-h-screen bg-[#050505] text-white flex flex-col relative overflow-hidden">
      ...
      <header className="relative z-10 p-6 sm:p-8 max-w-7xl mx-auto w-full">
        <Link to="/" className="inline-flex items-center gap-2 font-black text-xl sm:text-2xl tracking-tighter hover:opacity-80 transition-opacity">
          <div className="w-9 h-9 sm:w-10 sm:h-10 bg-gradient-to-tr from-blue-600 to-purple-600 rounded-xl flex items-center justify-center shadow-lg shadow-blue-500/20">
      ...
      <main className="flex-1 flex items-center justify-center p-4 sm:p-6 relative z-10">
        ...
        >
          ...
          <div className="text-center mb-8 sm:mb-10">
            ...
            <p className="text-gray-400 mt-2 sm:mt-3 text-xs sm:text-sm font-medium">Re-enter the modular universe.</p>
          </div>

          <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
            <div className="space-y-1.5 sm:space-y-2">
              <label className="text-[9px] sm:text-[10px] font-black uppercase tracking-[0.2em] text-gray-500 ml-1">Identity</label>
              <div className="relative group">
                <div className="absolute inset-y-0 left-0 pl-4 sm:pl-5 flex items-center pointer-events-none text-gray-500 group-focus-within:text-blue-500 transition-colors">
                  <Mail className="w-4 h-4 sm:w-5 sm:h-5" />
                </div>
                <input
                  type="text"
                  placeholder="Email or Username"
                  className="w-full bg-white/5 border border-white/10 p-4 sm:p-5 pl-11 sm:pl-14 rounded-xl sm:rounded-2xl focus:outline-none focus:border-blue-500/50 focus:bg-white/10 transition-all text-sm sm:text-base text-white placeholder:text-gray-700 font-bold"
                  value={identifier}
            ...
            <div className="space-y-1.5 sm:space-y-2">
              <div className="flex justify-between items-center ml-1">
                <label className="text-[9px] sm:text-[10px] font-black uppercase tracking-[0.2em] text-gray-500">Access Key</label>
                <a href="#" className="text-[9px] sm:text-[10px] font-black text-blue-500 hover:text-blue-400 transition-colors uppercase tracking-widest">Recovery</a>
              </div>
              <div className="relative group">
                <div className="absolute inset-y-0 left-0 pl-4 sm:pl-5 flex items-center pointer-events-none text-gray-500 group-focus-within:text-blue-500 transition-colors">
                ...
                <input
                  ...
                  className="w-full bg-white/5 border border-white/10 p-4 sm:p-5 pl-11 sm:pl-14 pr-11 sm:pr-14 rounded-xl sm:rounded-2xl focus:outline-none focus:border-blue-500/50 focus:bg-white/10 transition-all text-sm sm:text-base text-white placeholder:text-gray-700 font-bold"
                  value={password}
            ...
            <button 
              type="submit" 
              disabled={loading}
              className="w-full bg-white text-black font-black py-4 sm:py-5 rounded-xl sm:rounded-2xl transition-all active:scale-[0.98] shadow-xl shadow-white/5 flex items-center justify-center gap-3 group relative overflow-hidden"
            >
