...
export const CatalogPage = () => {
  ...
  const fetchAllData = async () => {
    ...
    try {
      ...
      // Process results individually to be resilient
      ...
      // If critical data (profile) failed and it's a 403, it's likely a scope issue
        ...
        {view === 'dashboard' ? (
          ...
          >
            {profile ? (
              ...
              <div className="bg-gray-900/40 p-10 rounded-[3rem] border border-gray-800/50 flex items-center justify-center">
                 <p className="text-gray-500 font-bold uppercase tracking-widest text-xs">Profile Data Unavailable</p>
              </div>
            )}
          </motion.div>
        ) : (
